...
export const Header: FC = () => {
	...
	return (
		<>
			<div id="top" className="h-2 w-full bg-pastel-blurple"></div>
			<motion.div
				className={`sticky md:static top-0 w-screen md:w-auto h-24 md:h-48 px-8 md:px-24 2xl:px-56
	...
	return (
		<>
			<button
				...
				onClick={() =>
					(window.location.href =
						"mailto:nasutionrachmat@gmail.com")
				}
			>
				<motion.div
					whileHover={{
...
const MobileDropDown = () => {
	return (
		<motion.div
			className="sticky top-20 w-screen px-10
		...
		>
			...
			<motion.div
				className="hover:cursor-pointer bg-pastel-blurple
			...
			>
				<p className="text-epic-black">nasutionrachmat@gmail.com</p>
			</motion.div>
		</motion.div>
	);
};
